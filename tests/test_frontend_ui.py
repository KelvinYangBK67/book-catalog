...
class FrontendStructureTests(unittest.TestCase):
    ...
    def test_special_script_renderer_is_local_and_keeps_unicode_inputs(self) -> None:
        ...
        self.assertIn('.rendered-text[data-font-route="manchu"]', CSS)
        self.assertIn(".manchu-script-run { font-size: 1.7em; line-height: 1.4; }", CSS)
        self.assertIn('input.script-input-override[data-font-route="manchu"]', CSS)
        self.assertIn("font-size: 1.7em", CSS)
        self.assertIn("line-height: 1.55", CSS)
